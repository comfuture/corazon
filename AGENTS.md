...
- You do not need to run `pnpm typecheck` and `pnpm lint` on every edit turn. Run both commands before committing, and fix any reported errors before creating the commit.
